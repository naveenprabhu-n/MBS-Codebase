...
gcloud compute instances describe $vm_instance_name --format="json" --zone=us-east4-a 
...
gcloud compute instances describe $vm_instance_name --format="value(metadata.items.$key.value)" --zone=us-east4-a 
